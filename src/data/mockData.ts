...
export const qualityKpis: QualityKpi[] = [
  { id: 'q-1', label: 'MTTR', value: '2.4 h', trend: '-0.4 h vs last month', criticality: 'Medium' },
  { id: 'q-2', label: 'MTBF', value: '141 h', trend: '+9 h vs last month', criticality: 'Low' },
  { id: 'q-3', label: 'Attenuation Drift', value: '0.22 dB/day', trend: 'Stable', criticality: 'Medium' },
  { id: 'q-4', label: 'SLA Availability', value: '99.6%', trend: '+0.1%', criticality: 'Critical' },
];

export interface NqmsMatrixRow {
  domain: 'RTU' | 'Fiber' | 'OTDR' | 'Alarms' | 'Performance';
  parameter: string;
  description: string;
  values: string;
  widgetType: string;
...
export const nqmsMatrixRows: NqmsMatrixRow[] = [
  {
    ...
    description: 'Overall RTU status',
  ...
  },
  {
    ...
    description: 'RTU internal temperature',
    values: 'C value + thresholds',
    widgetType: 'Gauge',
    criticality: 'Medium',
  },
  {
    ...
    description: 'OTDR availability',
    values: 'Ready / Busy / Fault',
    widgetType: 'Status icon',
    criticality: 'Critical',
  },
  {
    domain: 'Fiber',
    parameter: 'Fiber Status',
    description: 'Overall fiber status',
  ...
  },
  {
    ...
    description: 'Optical route status',
  ...
  },
  {
    ...
    description: 'Total attenuation',
    values: 'dB configurable threshold',
    widgetType: 'Gauge',
    criticality: 'Critical',
  },
  {
  ...
  },
  {
    ...
    description: 'Attenuation trend',
    values: 'Time series chart',
    widgetType: 'Chart',
    criticality: 'Medium',
  },
  {
